ACHIEVEMENTS = [
    ...
    ("parliament_member", {
        ...
        "image": "https://i.rustockholm.club/2582c2df41eb67114307e22ffee862fe923ab1843ce47781aee577cc3f2abb5f.jpg",
        "style": "background-color: #000000; font-size: 120%;",
    }),
    ("contributor", {
        "name": "Контри-бьютор",
        "description": "За значительный вклад в разработку Клуба",
        "image": "https://i.rustockholm.club/3ah.png",
    ...
    ("oscar", {
        ...
        "image": "https://i.rustockholm.club/3bd.png",
    ...
    ("offline", {
        ...
        "image": "https://i.rustockholm.club/3ai.png",
    ...
    ("altruist", {
        ...
        "image": "https://i.rustockholm.club/3d0.png",
    ...
    ("ideas", {
        ...
        "image": "https://i.rustockholm.club/3d1.png",
        "style": "background-color: #F04393; font-size: 100%;",
    }),
    ("2020", {
        "name": "2020",
        "description": "Призовое место в итогах 2020 года",
        "image": "https://rustockholm.club/static/images/achievements/2020.png",
    ...
    ("mic", {
        ...
        "image": "https://rustockholm.club/static/images/achievements/mic.png",
    ...
    ("hacker_1", {
        ...
        "image": "https://rustockholm.club/static/images/achievements/hack_1.png",
    ...
    ("hacker_2", {
        ...
        "image": "https://rustockholm.club/static/images/achievements/hack_2.png",
        "style": "background-color: #50c878; font-size: 120%;",
    }),
    ("hacker_3", {
        "name": "Хакер LVL 3",
        "description": "Выдаётся за участие в 5 клубных хакатонах, хактоберфестах или геймджемах",
        "image": "https://rustockholm.club/static/images/achievements/hack_3.png",
        "style": "background-color: #50c878; font-size: 120%;",
    }),
    ("hacker_4", {
        "name": "Хакер PRO",
        "description": "Выдаётся за участие в 10 клубных хакатонах, хактоберфестах или геймджемах",
        "image": "https://rustockholm.club/static/images/achievements/hack_4.png",
        "style": "background-color: #00a550; font-size: 120%;",
    }),
]

# VIP: https://i.rustockholm.club/3cb.png
