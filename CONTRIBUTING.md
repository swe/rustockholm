...
- [¯\\_(ツ)_/¯](https://github.com/rustockholm/rustockholm.club/labels/ ̄\_(ツ)_%2F ̄) - special label for **questionable issues**. (should be closed in 60 days of inactivity)
...
2. [Fork it](https://github.com/rustockholm/rustockholm.club/fork)
